...
class Calculator:
    ...
    def create_buttons(self):
        ...
        sqrt_button = tk.Button(self.root, text='√', font=('Arial', 18), command=lambda: self.on_button_click('√'))
        sqrt_button.grid(row=row_val, column=0, columnspan=2, sticky='nsew', padx=5, pady=5)
        
        clear_button = tk.Button(self.root, text='C', font=('Arial', 18), command=self.clear_display)
        clear_button.grid(row=row_val, column=2, columnspan=2, sticky='nsew', padx=5, pady=5)
